...
const quizData = [
    {
        ...
        correct: 1  // Сталинградская битва - правильный ответ
    },
    {
        ...
        options: [
            "Г.К. Жуков",
            "К.К. Рокоссовский", 
            "В.И. Чуйков",  // Правильный ответ
            "И.С. Конев"
        ],
        correct: 2  // В.И. Чуйков
    },
    {
    ...
    },
    {
        ...
        options: [
            ...
            "Егоров и Кантария",  // Правильный ответ
            "Василевский и Конев", 
            "Чуйков и Зайцев"
        ],
        correct: 1  // Егоров и Кантария
    },
    
    // Новые вопросы о добавленных сражениях (исправленные)
    {
        question: "Какая операция вошла в историю как самое стремительное наступление (20-30 км в день)?",
        options: [
            "Битва за Москву",
            "Висло-Одерская операция",  // Правильный ответ
            "Курская битва",
            "Сталинградская битва"
        ],
        correct: 1  // Висло-Одерская операция
    },
    {
        question: "Какова была продолжительность Висло-Одерской операции?",
        options: [
            "10 дней",
            "23 дня",  // Правильный ответ
            "45 дней",
            "60 дней"
        ],
        correct: 1  // 23 дня
    ...
    {
        question: "Какие потери понесла Германия в Висло-Одерской операции?",
        options: [
            "100 тыс. человек",
            "250 тыс. человек",
            "480 тыс. человек",  // Правильный ответ
            "600 тыс. человек"
        ],
        correct: 2  // 480 тыс. человек
    },
    {
        question: "Какой фронт НЕ участвовал в Висло-Одерской операции?",
        options: [
            "1-й Белорусский фронт",
            "1-й Украинский фронт", 
            "2-й Белорусский фронт",  // Правильный ответ - не участвовал
            "Все перечисленные участвовали"
        ],
        correct: 2  // 2-й Белорусский фронт
    },
    {
        question: "Какой город был освобожден 17 января 1945 года в ходе Висло-Одерской операции?",
        options: [
            "Берлин",
            "Прага",
            "Варшава",  // Правильный ответ
            "Будапешт"
        ],
        correct: 2  // Варшава
    },
    {
        question: "Какой город стал символом героической обороны в 1941 году на Украине?",
        options: [
            "Харьков",
            "Киев",  // Правильный ответ
            "Одесса",
            "Днепропетровск"
        ],
        correct: 1  // Киев
    ...
    {
        question: "Кто командовал советскими войсками в Киевской оборонительной операции 1941 года?",
        options: [
            "И.С. Конев",
            "Н.Ф. Ватутин",
            "М.П. Кирпонос",  // Правильный ответ
            "Г.К. Жуков"
        ],
        correct: 2  // М.П. Кирпонос
    },
    {
        question: "Сколько дней длилась героическая оборона Киева в 1941 году?",
        options: [
            "30 дней (1 месяц)",
            "60 дней (2 месяца)",
            "82 дня (почти 3 месяца)",  // Правильный ответ
            "120 дней (4 месяца)"
        ],
        correct: 2  // 82 дня
    },
    {
        question: "Какая река стала рубежом в битве за Днепр в 1943 году?",
        options: [
            "Волга",
            "Дон",
            "Днепр",  // Правильный ответ
            "Днестр"
        ],
        correct: 2  // Днепр
    },
    {
        question: "Когда было окончательное освобождение Харькова?",
        options: [
            "Февраль 1943",
            "Май 1943",
            "Август 1943",  // Правильный ответ - 23 августа 1943
            "Октябрь 1943"
        ],
        correct: 2  // Август 1943
    },
    {
        question: "Какая операция завершилась освобождением Севастополя 9 мая 1944 года?",
        options: [
            "Крымская наступательная операция",  // Правильный ответ
            "Одесская операция",
            "Карпатско-Ужгородская операция",
            "Ясско-Кишиневская операция"
        ],
        correct: 0  // Крымская наступательная операция
    },
    {
        question: "Кто командовал 4-м Украинским фронтом в Крымской наступательной операции?",
        options: [
            "И.С. Конев",
            "Ф.И. Толбухин",  // Правильный ответ
            "Р.Я. Малиновский",
            "К.К. Рокоссовский"
        ],
        correct: 1  // Ф.И. Толбухин
    },
    {
        question: "Какова была продолжительность Смоленского сражения 1941 года?",
        options: [
            "30 дней (1 месяц)",
            "62 дня (около 2 месяцев)",  // Правильный ответ (10 июля - 10 сентября)
            "90 дней (3 месяца)",
            "120 дней (4 месяца)"
        ],
        correct: 1  // 2 месяца
    ...
    {
        question: "Какой стратегический результат имело Смоленское сражение?",
        options: [
            "Разгром группы армий 'Центр'",
            "Задержка наступления на Москву на 2 месяца",  // Правильный ответ
            "Освобождение Смоленска",
            "Прорыв блокады Ленинграда"
        ],
        correct: 1  // Задержка наступления на Москву
    },
    {
        question: "Какое сражение сорвало немецкий план 'Тайфун'?",
        options: [
            "Смоленское сражение",
            "Битва за Москву",  // Правильный ответ
            "Киевская операция",
            "Харьковское сражение"
        ],
        correct: 1  // Битва за Москву
    },
    {
        question: "Какое из этих сражений было самым кровопролитным?",
        options: [
            "Сталинградская битва",
            "Битва за Днепр",
            "Курская битва",
            "Все перечисленные были очень кровопролитными"  // Правильный ответ
        ],
        correct: 3  // Все были кровопролитными
    },
    {
        question: "Когда началась Битва за Днепр?",
        options: [
            "Июнь 1943",
            "Август 1943",  // Правильный ответ (26 августа)
            "Сентябрь 1943",
            "Октябрь 1943"
        ],
        correct: 1  // Август 1943
    }
];
...
function showQuestion(index) {
    ...
    questionContainer.innerHTML = `
        <div class="question-header">
            <span class="question-number">Вопрос ${index + 1} из ${quizData.length}</span>
            <span class="question-difficulty">${getDifficulty(index)}</span>
        </div>
    ...
    if (index === quizData.length - 1) {
        document.getElementById('next-btn').textContent = 'Завершить викторину';
    } else {
        document.getElementById('next-btn').textContent = 'Следующий вопрос';
    }
...
function getDifficulty(index) {
    // Первые 5 вопросов - легкие (базовые знания)
    if (index < 5) return "Лёгкий";
    // Следующие 5 - средние (общие сражения)
    if (index < 10) return "Средний";
    // Следующие 5 - сложные (специфические детали)
    if (index < 15) return "Сложный";
    // Последние 7 - экспертные (детальные знания)
    return "Экспертный";
}
...
function reviewWrongAnswers() {
    ...
    userAnswers.forEach((answer, index) => {
        if (answer !== quizData[index].correct) {
            wrongQuestions.push({
                ...
                userAnswer: quizData[index].options[answer] || "Не ответил",
    ...
    let reviewHtml = `
        <div class="review-container">
            <h3>Анализ ошибок (${wrongQuestions.length} вопросов)</h3>
    `;
    
    if (wrongQuestions.length === 0) {
        reviewHtml += `
            <div class="no-errors">
                <p>🎉 Поздравляем! У вас нет ошибок!</p>
                <p>Вы ответили правильно на все вопросы викторины.</p>
            </div>
        `;
    } else {
    ...
    reviewHtml += `
            <div class="review-buttons">
                <button class="quiz-btn" id="back-to-results">Вернуться к результатам</button>
            </div>
        </div>
    `;
